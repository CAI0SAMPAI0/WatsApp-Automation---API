...
from agent.core.db import db
from agent.core.automation import contador_execucao
from agent.core.paths import get_whatsapp_profile_dir, get_app_base_dir
from agent.core import windows_scheduler
...
class Api:
    ...
    def _executar_lote_sequencial(self, itens, temp_dir, ts):
        import pyperclip
        from agent.core.automation import (
            iniciar_driver,
            enviar_arquivo_com_mensagem,
            _abrir_conversa,
        )
        from agent.core.paths import get_whatsapp_profile_dir
